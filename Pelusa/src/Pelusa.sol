...
contract Pelusa {
    address private immutable owner; // set pseudo randomly at deployment
    ...
    function passTheBall() external {
        require(msg.sender.code.length == 0, "Only EOA players"); // forces me to do the exploit in a contract's constructor
